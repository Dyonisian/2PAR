...
public class ARLine : MonoBehaviour
{
    ...
    public Niantic.ARDK.AR.Anchors.IARAnchor _arAnchor;
    ...
    public void AddNewLineRenderer(Transform parent, Niantic.ARDK.AR.Anchors.IARAnchor anchor, Vector3 position)
    {
        _arAnchor = anchor;
        positionCount = 2;
